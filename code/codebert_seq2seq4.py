...
class Seq2Seq(nn.Module):
    ...
    def forward(self, x=None, edge_index=None, edge_attr=None, batch=None, subgraph_node_num=None, real_graph_num=None,
        ...
        if x is not None:
            ...
            encoder_output = outputs.unsqueeze(0)
            # print('encoder output', encoder_output.shape)
        ...
        if target_ids is not None:
            ...
            out = self.decoder(
                tgt_embeddings, encoder_output, tgt_mask=attn_mask)
            ...
            for i in range(torch.unique(batch).size(0)):
                ...
                for _ in range(self.max_length):
                    ...
                    out = self.decoder(
                        tgt_embeddings, context, tgt_mask=attn_mask)
