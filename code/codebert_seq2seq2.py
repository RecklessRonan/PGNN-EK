...
class Seq2Seq(nn.Module):
    ...
    def forward(self, x=None, edge_index=None, edge_attr=None, batch=None,
                source_ids=None, source_mask=None, target_ids=None, target_mask=None, args=None):
        ...
        outputs2 = self.gnn_encoder(x, edge_index, edge_attr, batch)
        encoder_output2 = outputs2.unsqueeze(0).expand(encoder_output1.shape[0], -1, -1)
